...
code1=open('./Code Sub-Module1.txt','r').read()
exec(code1)
print(1)
code2=open('./Code Sub-Module2.txt','r').read()
exec(code2)
print(2)
code3=open('./Code Sub-Module3.txt','r').read()
exec(code3)
print(3)
code4=open('./Code Sub-Module4.txt','r').read()
exec(code4)
print(4)
